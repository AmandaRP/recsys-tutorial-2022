...
> TODO: Awesome quote from Lex. See format here. https://quarto.org/docs/authoring/markdown-basics.html
...
![](images/netflix_fig2.png){width=80%}
:::

::: {.column width="50%"}

- Matrix factorization (aka latent factor model)
...
## Additional Reading: Explainable Recommendations

- [Measuring "Why" in Recommender Systems: a Comprehensive Survey on the Evaluation of Explainable Recommendation](https://arxiv.org/pdf/2202.06466.pdf)

## Terminology: Two-tower Sysetms

![](images/two-tower.png){fig-align='center' height=350}

<center>Used for item retreival (as opposed to ranking).</center>

::: aside

Image source: https://www.linkedin.com/pulse/personalized-recommendations-iv-two-tower-models-gaurav-chakravorty. See also [Sampling-Bias-Corrected Neural Modeling for Large Corpus
Item Recommendations](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/6c8a86c981a62b0126a11896b7f6ae0dae4c3566.pdf).
...
Raza, S., Ding, C. [News recommender system: a review of recent progress, challenges, and opportunities](https://doi.org/10.1007/s10462-021-10043-x). Artif Intell Rev 55, 749–800 (2022). 
...
| Metric               | Range | Best |
|:---------------------|-------|:------:|
| Hit Rate at $k$ (HR@$k$) | [0,1] | 1  |
| Mean Average Precision at $k$ (MAP@$k$) | [0,1] | 1    |
| Normalized Discounted Cumulative Gain (NDCG@$k$) | [0,1] | 1    |
| Mean Reciprocal Rank (MRR) | [0,1] | 1    |
...
| Metric               | Range |
|:---------------------|:-----:|
| Diversity at k (Div@k) | [0,1] |
| Novelty at k (Nov@k) | [0,1] |
| Catalog coverage (CC) | [0,1] |
