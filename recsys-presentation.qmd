...
We're working with the **M**icrosoft **N**ews **D**ataset this summer! 
...
## Unique Challenges of News Recommendation

- High rate of "cold start" items (articles)
- Short shelf-lives 
- A user may get bored by a news feed with lack of diversity.
